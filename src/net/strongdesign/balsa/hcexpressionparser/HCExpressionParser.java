...
public class HCExpressionParser implements HCChannelSenseController, HCExpressionParserConstants {
  ...
  final public HCTerm hcSyncProduct() throws ParseException {
  ...
  private boolean jj_3_11() {
    if (jj_scan_token(SYNCPROD)) return true;
  ...
  private boolean jj_3_35() {
    if (jj_scan_token(OUTP)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3_27()) {
    jj_scanpos = xsp;
